...
with open("levels/levels1.json", "r") as file:
...
def reset_level():
    ...
    lava_group.empty()
    exit_group.empty()
    with open(f"levels/levels{levels}.json", "r") as file:
        world_data = json.load(file)
...
class Exit(pygame.sprite.Sprite):
    def __init__(self, x, y):
        pygame.sprite.Sprite.__init__(self)
        img = pygame.image.load("images/exit_dor.png")
...
class Lava(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.transform.scale(images,
...
start_button = Button(width // 2, height // 3, "images/start_btn.png")
exit_button = Button(width // 2, height // 2, "images/exit_btn.png")
